		...
		while(true) {
			...
			case 1:
				...
				do {
					...
					// Si se generó un error al momento de crear el usuario la variable va a valer "true"
					// Por contrario si no hubo nigún error va a devolver "false"
			...
			default:
				System.out.println("El número ingresado no coincide con ninguna de las opciones del men�.");
				break;
			}
